...
function ModalSwitch(){
    ...
    let backgroud = location.state && location.state.backgroud
    ...
    return(
        <div>
            ...
            { backgroud && <Route path="/img/:id" children={<Modal />} /> }
        </div>
    )
}
...
function Image({ color }){
    return(
        <div style={{ width: "100%", height: 400, background: color }} />
    )
}
